  ...
  <div class="table">
    ...
    <div class="container">
      <div class="handle-box">
        <el-input v-model="searchName" placeholder="搜索活动名称" class="handle-input mr10"></el-input>
      ...
      <el-table :data="tableData" border class="table" ref="multipleTable" @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="articleTitle" label="对应文章">
          <template slot-scope="scope" v-if="scope.row.articleTitle">
            <div>{{scope.row.articleTitle}}（id:{{scope.row.articleId}}）</div>
          </template>
        </el-table-column>
    ...
    <!-- 删除提示框 -->
    <el-dialog title="删除活动提示" :visible.sync="delVisible" width="300px" center>
