  ...
  <div class="table">
    ...
    <div class="container">
      <div class="handle-box">
        <el-input v-model="searchName" placeholder="搜索案例名称" class="handle-input mr10"></el-input>
        <el-button type="primary" icon="search" @click="search">搜索</el-button>
        <el-button type="primary" icon="search" @click="handleAdd">添加</el-button>
      </div>
      <el-table :data="tableData" border class="table" ref="multipleTable" @selection-change="handleSelectionChange">
        <el-table-column prop="id" label="案例id">
        </el-table-column>
        ...
        <el-table-column prop="desc" label="摘要" sortable>
        </el-table-column>
      ...
      <el-form ref="form" :model="addForm" label-width="100px">
        ...
        <el-form-item label="图片">
          ...
          <div class="crop-demo-btn">选择图片
            <input class="crop-input" type="file" name="image" accept="image/*" @change="setImage($event, 1)"/>
          </div>
        </el-form-item>
    ...
    <el-dialog title="修改案例" :visible.sync="editVisible" width="60%">
      <el-form ref="form" :model="editForm" label-width="100px">
        ...
        <el-form-item label="图片">
          ...
          <div class="crop-demo-btn">选择图片
            <input class="crop-input" type="file" name="image" accept="image/*" @change="setImage($event, 2)"/>
          </div>
        </el-form-item>
        <el-form-item label="摘要">
        ...
        <el-form-item label="内容">
          <quill-editor ref="myTextEditor1" v-model="editForm.content" ></quill-editor>
        </el-form-item>
      </el-form>
      <span slot="footer" class="dialog-footer">
    ...
    <!-- 删除提示框 -->
    <el-dialog title="删除案例提示" :visible.sync="delVisible" width="300px" center>
